...
enhanced.IDC <- EnhancedCluster(IDC, q = 10, d = 15, platform = "Visium", gamma = 3, n.rep = 10, ncores = 2, jitter_scale = 20, jitter_prior = 10)
```

```{r IDC enhanced cluster plots}
enhanced.IDC$spatial.cluster <- dplyr::recode(enhanced.IDC$spatial.cluster, 6, 9, 2, 5, 1, 4, 3, 10, 8, 7)
...
p1 <- box.feature("MKI67")
p2 <- box.feature("MUC1")
p3 <- box.feature("ZNF703")
...
g3 +  coord_fixed(ratio = 1.5)   + g4  + coord_fixed(ratio = 1.5)
```
